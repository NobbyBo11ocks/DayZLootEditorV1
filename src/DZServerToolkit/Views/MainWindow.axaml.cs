...
namespace DZServerToolkit.Views;
...
public partial class MainWindow : Window
{
    ...
    {
        if (DataContext is TypesEditorViewModel viewModel)
        {
            await viewModel.TryAutoDetectAndOpenDayzServerAsync().ConfigureAwait(true);
        }
    }
